#!/usr/bin/env python3
"""
Hardened Stage-0 factual-source downloader.
...
def download_with_curl(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="hm_fact_dl_") as tmpdir_s:
        tmpdir = Path(tmpdir_s)
        body_tmp = tmpdir / "body.tmp"
        header_tmp = tmpdir / "headers.txt"
        cmd = [
            curl,
            "--location",
            "--fail",
        ...
        # subprocess timeout is a hard kill switch beyond curl's own max-time.
